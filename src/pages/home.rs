      ...
      <body>
        ...
        <div class="format">
          <div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
            ...
            <p class="title" style="">Your quick start to building awseome Rust projects.</p>
            <br>
            <div style="text-align: left;">
              ...
              <p class="text-format">This website is built entirely in standard vanilla Rust with OpenSSL! No frameworks no librarys.</p>
            </div>
          </div>
        </div>
      </body>
